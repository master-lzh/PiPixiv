...
fun PictureSourceWidget(
    ...
    val map = remember {
        mapOf(
            "i.pximg.net" to "${AppUtil.getString(R.string.label_default)}: i.pximg.net",
    ...
    Surface(
        ...
        Column {
            SettingItem {
                Text(text = stringResource(R.string.image_source))
                IconButton(
                    onClick = {
            ...
            SettingItem {
                ...
                TextField(
                    ...
                    singleLine = true,
                    label = { Text(text = stringResource(R.string.self_defined_source)) },
                    trailingIcon = {
